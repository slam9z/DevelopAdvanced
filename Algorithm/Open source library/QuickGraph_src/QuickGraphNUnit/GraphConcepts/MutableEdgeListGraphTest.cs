...
namespace QuickGraphNUnit.GraphConcepts
{
	...
	public class GenericMutableEdgeListGraphTest
	{
	...
	[TestFixture]
	public class IncidenceMutableEdgeListGraphTest : GenericMutableEdgeListGraphTest
	{
		[SetUp]
		public void Init()
		{
	...
	[TestFixture]
	public class BidirectionaleMutableEdgeListGraphTest : GenericMutableEdgeListGraphTest
	{
		[SetUp]
		public void Init()
		{
