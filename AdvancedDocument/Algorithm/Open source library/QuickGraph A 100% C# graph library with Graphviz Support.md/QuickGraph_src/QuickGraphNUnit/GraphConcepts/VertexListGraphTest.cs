...
namespace QuickGraphNUnit.GraphConcepts
{
	...
	public class GenericVertexListGraphTest
	{
	...
	[TestFixture]
	public class IncidenceVertexListGraphTest : GenericVertexListGraphTest
	{
		[SetUp]
		public void Init()
		{
	...
	[TestFixture]
	public class BidirectionalVertexListGraphTest : GenericVertexListGraphTest
	{
		[SetUp]
		public void Init()
		{
